...
public class BasicFirstExample {
    ...
    private Host createHost() {
        ...
        */
        List<Float> oversubscriptionLevels = Arrays.asList(new Float(1.0), new Float(2.0), new Float(3.0));
        return new HostMultiClusters(HOST_RAM, HOST_BW, HOST_STORAGE, peList, oversubscriptionLevels);
    }
    ...
    private List<Vm> createVms() {
        ...
        for (int i = 0; i < VMS; i++) {
            final var vm = new VmOversubscribable(HOST_MIPS, VM_PES, new Float(2.0));
